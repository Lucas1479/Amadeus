...
<img src="./assets/header.en.svg" width="880" alt="Amadeus — conversation, performance, and execution on one timeline: interruptible voice, speech-synced performance, delegated providers, resumable and steerable"/>
